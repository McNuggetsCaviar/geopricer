export const CITIES = {
  manila: {
    ...
    audioClips: {
      zone: '02_manille_zone',
      history: ['03_manille_rammasun', '04_manille_ketsana'],
      aal: '05_manille_aal',
      mitigation: '06_manille_mitigation',
      roi: '06_manille_mitigation',
    },
  ...
  miami: {
    ...
    audioClips: {
      zone: '07_miami_zone',
      history: '07_miami_zone',
      aal: '07_miami_zone',
      mitigation: '07_miami_zone',
      roi: '07_miami_zone',
    },
  ...
  tokyo: {
    ...
    audioClips: {
      zone: '08_tokyo_zone',
      history: '08_tokyo_zone',
      aal: '08_tokyo_zone',
      mitigation: '08_tokyo_zone',
      roi: '08_tokyo_zone',
    },
